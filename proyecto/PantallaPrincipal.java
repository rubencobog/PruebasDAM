...
public class PantallaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnExport.setText("Exportar ruta");
                ...
                .addGroup(PantallaVerRutasLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, PantallaVerRutasLayout.createSequentialGroup()
                        ...
                        .addGroup(PantallaVerRutasLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(btnVolverVerRutas, javax.swing.GroupLayout.Alignment.TRAILING))))
                .addGap(35, 35, 35)
        ...
        PantallaValidarUsuariosLayout.setHorizontalGroup(
            ...
            .addGroup(PantallaValidarUsuariosLayout.createSequentialGroup()
                .addGap(89, 89, 89)
                .addGroup(PantallaValidarUsuariosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(PantallaValidarUsuariosLayout.createSequentialGroup()
            ...
            .addGroup(PantallaPuntoInteresLayout.createSequentialGroup()
                ...
                .addGroup(PantallaPuntoInteresLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(PantallaPuntoInteresLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(txtLatitudPuntoInteres, javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(txtLongitudPuntoInteres, javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addComponent(txtNumPuntoInteres, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 130, Short.MAX_VALUE)))
                .addGap(6, 6, 6)
                .addGroup(PantallaPuntoInteresLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void btnExportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExportActionPerformed
        ...
        if (seleccion != -1) {
            String id_string = (String) TablaRutas.getValueAt(seleccion, 0);
            int id = Integer.parseInt(id_string);
            Ruta rutaSeleccionada = rutas.obtenerRutaPorId(id);
            ...
            if (fileChooser.showSaveDialog(this) == JFileChooser.APPROVE_OPTION) {
                ...
                String nombreArchivo = rutaSeleccionada.getNombre().replaceAll("[^a-zA-Z0-9_\\-]", "_") + ".csv";
                String rutaCompleta = carpeta.getAbsolutePath() + File.separator + nombreArchivo;
 
                ExportCSV.exportarRuta(rutaSeleccionada, rutaCompleta);
 
                JOptionPane.showMessageDialog(this, "Ruta exportada correctamente a:\n" + rutaCompleta);
            }
        } else {
            JOptionPane.showMessageDialog(this, "Debes seleccionar una ruta primero.");
        }
    ...
    public void cargarTablaRutas() {
        ...
        String[] columnas = {"ID", "Nombre", "Distancia", "Duracion", "Clasificacion", "Zona G.", "Esfuerzo", "Desnivel acumulado", "Tipo de terreno", "Valoracion media"};
        ...
        for (Ruta r : listarutas) {
            String[] datos = {String.valueOf(r.getId_ruta()), r.getNombre(), String.valueOf(r.getDistancia_total()), String.valueOf(r.getDuracion()), r.getClasificacion().toString(),
                r.getZona_geografica(), String.valueOf(r.getNivel_esfuerzo()), String.valueOf(r.getDesnivel_acumulado()),
